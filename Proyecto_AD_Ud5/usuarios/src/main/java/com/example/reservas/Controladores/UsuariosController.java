...
public class UsuariosController {
    ...
    public ResponseEntity<String> obtenerInfoUsuarioPorId(@PathVariable Integer id) {
        try {
            ...
            return ResponseEntity.badRequest().body("No existe ningún usuario con dicho id");
        }
    }
    ...
    public ResponseEntity<String> obtenerInfoUsuarioPorNombre(@PathVariable String nombre) {
        try {
            ...
            return ResponseEntity.badRequest().body("No existe ningún usuario con dicho nombre");
        }
    }
